(function () {
  const translations = {
    en: {
      ...
      "taskrabbit.title": "View the profile, check rates or book directly through Taskrabbit.",
      "taskrabbit.text": "Benjamin-Brian E. is listed on Taskrabbit for furniture assembly and wall mounting. There you can find the current rates, booking flow and further profile information.",
      "taskrabbit.fact1": "ID checked",
      "taskrabbit.fact2": "Tasker since 2026",
      "taskrabbit.fact3": "Furniture assembly & wall mounting",
      ...
      "faq5.a": "Yes. Through my Taskrabbit profile you can view the rates currently shown there and the booking flow.",
